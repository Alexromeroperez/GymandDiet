...
<!-- Bootstrap Core CSS -->
<link href="sites/css/bootstrap.css" rel='stylesheet' type='text/css' />
<!-- Custom CSS -->
<link href="sites/css/style.css" rel='stylesheet' type='text/css' />
<!-- font CSS -->
<link rel="icon" href="favicon.ico" type="image/x-icon" >
<!-- font-awesome icons -->
<link href="sites/css/font-awesome.css" rel="stylesheet"> 
<!-- //font-awesome icons -->
<!--webfonts-->
<link href='//fonts.googleapis.com/css?family=Roboto+Condensed:400,300,300italic,400italic,700,700italic' rel='stylesheet' type='text/css'>
<!--//webfonts--> 
<!-- js -->
<script src="sites/js/jquery-1.11.1.min.js"></script>
<!-- //js -->
</head> 
<body class="login-bg">
		<div class="login-body">
			...
			<div class="login-info">
					...
					<input type="text" class="user" name="usuario" placeholder="Email" required="">
					...
					<div class="signup-text">
						¿No tienes cuenta?<a href="signup.html"> Registrate</a>
					</div>
				</form>
			</div>
		</div>
